...
using DDS.LocaDorr.Common.Results.Errors;
using DDS.LocaDorr.Common.Results;
using DDS.LocaDorr.Common.Persistence.Repositories;
using DDS.LocaDorr.Common.Entities;

namespace DDS.LocaDorr.Common.Services;
